...
def parse_args() -> argparse.Namespace:
    ...
    parser.add_argument("--output-path", type=Path, default=Path("docker/tugraph-tmp/tcg_walks_d128_light_shrcr.txt"))
    parser.add_argument("--id-map-path", type=Path, default=Path("docker/tugraph-tmp/tcg_node_id_map_d128_light_shrcr.csv"))
