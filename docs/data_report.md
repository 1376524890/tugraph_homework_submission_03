...
| 文件 | 内容 |
| --- | --- |
| `data/rebuild/hcg/endpoints.csv` | Endpoint 顶点。 |
| `data/rebuild/hcg/communicates.csv` | COMMUNICATES 聚合边。 |
...
| 文件或目录 | 内容 |
| --- | --- |
| `data/rebuild/tcg/flows.csv` | Flow 顶点。 |
| `data/rebuild/tcg/causes_full_parts/relation_type=CR/*.csv` | CR 因果边分区。 |
| `data/rebuild/tcg/causes_full_parts/relation_type=PR/*.csv` | PR 因果边分区。 |
| `data/rebuild/tcg/causes_full_parts/relation_type=DHR/*.csv` | DHR 因果边分区。 |
| `data/rebuild/tcg/causes_full_parts/relation_type=SHR/*.csv` | SHR 因果边分区。 |
| `data/rebuild/reports/tcg_edge_estimation_report.md` | TCG 边数量估算报告。 |
